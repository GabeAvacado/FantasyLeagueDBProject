...
?>
    <form class="addPlayers"action="addUserPlayers.php" method="post">
      <button type="submit" name="addUserPlayers">Add Players</button>
    </form>
    <form action="../includes/removeUserPlayers-inc.php" method="post">
      <input type="text" name="player_name" placeholder="Player to remove..">
      <button type="submit" name="removeUserPlayers-submit">Remove</button>
    </form>
