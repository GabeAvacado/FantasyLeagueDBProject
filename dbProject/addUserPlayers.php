...
?>
      ...
      <form action="../includes/addUserPlayers-inc.php" method="post">
        <input type="text" name="team_name" placeholder="Team to add to..">
        <input type="text" name="player_name" placeholder="Player to add..">
        <button type="submit" name="addUserPlayers-submit">Add</button>
      </form>
